    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticketing_href_centrale_pack', models.URLField(blank=True, default=cla_registration.models.RegistrationSession.DefaultTicketingHref.ticketing_href_centrale_pack, null=True, verbose_name='Billeterie "[Centrale Lille] Pack Alumni+CLA"')),
                ('ticketing_href_centrale_cla', models.URLField(blank=True, default=cla_registration.models.RegistrationSession.DefaultTicketingHref.ticketing_href_centrale_cla, null=True, verbose_name='Billeterie "[Centrale Lille] Adhésion CLA"')),
                ('ticketing_href_centrale_dd_pack', models.URLField(blank=True, default=cla_registration.models.RegistrationSession.DefaultTicketingHref.ticketing_href_centrale_dd_pack, null=True, verbose_name='Billeterie "[Centrale Lille][Double diplôme] Pack Alumni+CLA"')),
                ('ticketing_href_centrale_dd_cla', models.URLField(blank=True, default=cla_registration.models.RegistrationSession.DefaultTicketingHref.ticketing_href_centrale_dd_cla, null=True, verbose_name='Billeterie "[Centrale Lille][Double diplôme] Adhésion CLA"')),
                ('ticketing_href_iteem_pack', models.URLField(blank=True, default=cla_registration.models.RegistrationSession.DefaultTicketingHref.ticketing_href_iteem_pack, null=True, verbose_name='Billeterie "[ITEEM] Pack Alumni+CLA"')),
                ('ticketing_href_iteem_cla', models.URLField(blank=True, default=cla_registration.models.RegistrationSession.DefaultTicketingHref.ticketing_href_iteem_cla, null=True, verbose_name='Billeterie "[ITEEM] Adhésion CLA"')),
            ],
        ),
        migrations.CreateModel(
            name='Registration',
