...
class ReservationFoyerAssociationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['start_date'].help_text = mark_safe(f"Pensez à consulter <a target='_blank' href='{resolve_url('cla_reservation:public:foyer-planning')}'>le calendrier des réservations</a>")
