...
class ReservationBibliAssociationForm(forms.ModelForm):
    class Meta:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['start_date'].help_text = mark_safe(f"Pensez à consulter <a target='_blank' href='{resolve_url('cla_reservation:public:bibli-planning')}'>le calendrier des réservations</a>")
...
class ReservationBibliMemberForm(forms.ModelForm):
    class Meta:
        model = ReservationBibli
        fields = [
            'start_date',
...
class ReservationBibliAssociationAdminForm(forms.ModelForm):
    class Meta:
        model = ReservationBibli
        fields = [
            'start_date',
...
class ReservationBibliMemberAdminForm(forms.ModelForm):
    class Meta:
        model = ReservationBibli
        fields = [
            'start_date',
...
class ReservationBibliValidateForm(forms.ModelForm):
    class Meta:
        model = ReservationBibli
        fields = [
            'starts_on',
...
class ReservationBibliRejectForm(forms.ModelForm):
    class Meta:
        model = ReservationBibli
        fields = [
            'rejected_for'
...
class BlockedSlotBibliForm(BlockedSlotForm):
