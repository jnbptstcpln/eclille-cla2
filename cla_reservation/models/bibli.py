...
class ReservationBibli(models.Model):
    ...
    event = models.OneToOneField(Event, on_delete=models.CASCADE, related_name="reservation_bibli", null=True, blank=True, verbose_name="Réserver dans le cadre de cet événement", editable=False)
    ...
    def send_notification(self):
        try:
            permission = Permission.objects.filter(content_type__app_label='cla_reservation', codename='change_reservationbibli').first()
