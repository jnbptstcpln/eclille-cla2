...
class LoginForm(forms.Form):
                ...
                if hasattr(user, "infos"):
                    if user.infos.activated_on is None:
                        raise forms.ValidationError(
                            "Ce compte n'a pas encore été activé, veuillez consulter votre adresse mail en @xxxx.centralelille.fr"
                        )
    ...
    username = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "prenom.nom"}
        ),
...
class ForgotForm(forms.Form):
    ...
    email = forms.EmailField(
        ...
        required=True,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "prenom.nom@example.com"}
        ),
